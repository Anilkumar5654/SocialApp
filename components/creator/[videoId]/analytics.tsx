...
import { Eye, Clock, Heart, MessageCircle, Share2, DollarSign, Users, Target, Globe, TrendingUp } from 'lucide-react-native';
import React from 'react';
import { View, Text, StyleSheet, ScrollView, ActivityIndicator, TouchableOpacity, Dimensions } from 'react-native';
import { Image } from 'expo-image';
import { useQuery } from '@tanstack/react-query'; // Using useQuery for cleaner state management
...
// --- HELPER FUNCTIONS (Assuming moved to utils/format.ts) ---
// For functional integrity, keeping them here temporarily, but they belong in utils/format.ts
