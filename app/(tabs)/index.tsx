...
function CommentsModal({
  ...
  const { data: commentsData, isLoading } = useQuery<{ comments: any[] }>({
...
function PostItem({ post }: { post: Post }) {
  ...
  // Mutations
  const likeMutation = useMutation<{ isLiked: boolean; likes: number }>({
  ...
  const followMutation = useMutation<{ isFollowing: boolean }>({
