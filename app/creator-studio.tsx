          ...
          {!hideStats && (
             <View style={styles.contentStats}>
                <View style={styles.contentStatItem}>
                    ...
                    <Text style={styles.contentStatItemText}>
...
export default function CreatorStudioScreen() {
  ...
  const loadCreatorData = async () => { 
      ...
      try { 
          const channelResponse: any = await api.channels.checkUserChannel(user?.id || ''); 
  ...
  const handleContentPress = (type: 'post' | 'reel' | 'video', id: string) => { 
      ...
      else if (type === 'reel') { router.push('/reels'); } 
      else if (type === 'video') { router.push({ pathname: '/videos/player', params: { videoId: id } }); } 
  };
              ...
              <>
                ...
                <View style={styles.section}>
                  ...
                  <View style={styles.revenueItem}>
                    <View><Text style={styles.revenueTitle}>Ad Revenue</Text><Text style={styles.revenueDescription}>From video ads</Text></View>
                  ...
                  <View style={styles.revenueItem}>
                    <View><Text style={styles.revenueTitle}>Reels Bonus</Text><Text style={styles.revenueDescription}>Performance bonus</Text></View>
